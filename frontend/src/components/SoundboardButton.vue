...
<template>
  <button @contextmenu="rightClickAction" @click="play"
    class="relative overflow-hidden transition-colors transition-transform duration-150 ease-in-out hover:scale-105 border border-gray-500 my-1 md:border-0 w-screen h-10 md:w-40 md:h-32 md:rounded-xl md:m-2 md:p-4"
